...
class Migration_prg_gds15 extends \CodeIgniter\Database\Migration {

    public function up()
    {
        $this->db->query("
            CREATE TABLE prg_examiners_gds15(
            ...
            COMMENT 'ข้อมูลการทดสอบ GDS15';
        ");
    }

    public function down()
    {
        $this->dbforge->drop_table('prg_examiners_gds15');
    }
}
?>