...
class Migration_prg_sarcopenia_loco extends \CodeIgniter\Database\Migration {

    public function up()
    {
        $this->db->query("
            CREATE TABLE prg_examiners_sarcopenia_loco(
            ...
            COMMENT 'ข้อมูลการทดสอบ sarcopenia_loco';
        ");
    }

    public function down()
    {
        $this->dbforge->drop_table('prg_examiners_sarcopenia_loco');
    }
}
?>