...
class Migration_prg_instrumental extends \CodeIgniter\Database\Migration {

    public function up()
    {
        $this->db->query("
            CREATE TABLE prg_examiners_instrumental(
            ...
            COMMENT 'ข้อมูลการทดสอบ instrumental';
        ");
    }

    public function down()
    {
        $this->dbforge->drop_table('prg_examiners_instrumental');
    }
}
?>