...
class Migration_prg_fra_b extends \CodeIgniter\Database\Migration {

    public function up()
    {
        $this->db->query("
            CREATE TABLE prg_examiners_fra_b(
            ...
            COMMENT 'ข้อมูลการทดสอบ fra b';
        ");
    }

    public function down()
    {
        $this->dbforge->drop_table('prg_examiners_fra_b');
    }
}
?>