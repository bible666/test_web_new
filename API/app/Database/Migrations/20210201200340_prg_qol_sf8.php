...
class Migration_prg_qol_sf8 extends \CodeIgniter\Database\Migration {

    public function up()
    {
        $this->db->query("
            CREATE TABLE prg_examiners_qol_sf8(
            ...
            COMMENT 'ข้อมูลการทดสอบ QOL SF8';
        ");
    }

    public function down()
    {
        $this->dbforge->drop_table('prg_examiners_qol_sf8');
    }
}
?>