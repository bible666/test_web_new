...
class Migration_prg_comprehensive extends \CodeIgniter\Database\Migration {

    public function up()
    {
        $this->db->query("
            CREATE TABLE prg_examiners_comprehensive(
            ...
            COMMENT 'ข้อมูลการทดสอบ comprehensive';
        ");
    }

    public function down()
    {
        $this->dbforge->drop_table('prg_examiners_comprehensive');
    }
}
?>