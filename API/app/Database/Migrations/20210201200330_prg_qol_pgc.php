...
class Migration_prg_qol_pgc extends \CodeIgniter\Database\Migration {

    public function up()
    {
        $this->db->query("
            CREATE TABLE prg_examiners_qol_pgc(
            ...
            COMMENT 'ข้อมูลการทดสอบ QOL PGC';
        ");
    }

    public function down()
    {
        $this->dbforge->drop_table('prg_examiners_qol_pgc');
    }
}
?>