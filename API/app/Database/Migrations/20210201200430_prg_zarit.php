...
class Migration_prg_zarit extends \CodeIgniter\Database\Migration {

    public function up()
    {
        $this->db->query("
            CREATE TABLE prg_examiners_zarit(
            ...
            COMMENT 'ข้อมูลการทดสอบ zarit';
        ");
    }

    public function down()
    {
        $this->dbforge->drop_table('prg_examiners_zarit');
    }
}
?>