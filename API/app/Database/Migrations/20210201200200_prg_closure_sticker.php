...
class Migration_prg_closure_sticker extends \CodeIgniter\Database\Migration {

    public function up()
    {
        $this->db->query("
            CREATE TABLE prg_examiners_closure_sticker(
            ...
            COMMENT 'ข้อมูลการทดสอบ closure sticker';
        ");
    }

    public function down()
    {
        $this->dbforge->drop_table('prg_examiners_closure_sticker');
    }
}
?>