...
class Migration_prg_fra extends \CodeIgniter\Database\Migration {

    public function up()
    {
        $this->db->query("
            CREATE TABLE prg_examiners_fra(
            ...
            COMMENT 'ข้อมูลการทดสอบ fra';
        ");
    }

    public function down()
    {
        $this->dbforge->drop_table('prg_examiners_fra');
    }
}
?>