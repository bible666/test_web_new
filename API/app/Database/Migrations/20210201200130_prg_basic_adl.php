...
class Migration_prg_basic_adl extends \CodeIgniter\Database\Migration {

    public function up()
    {
        $this->db->query("
            CREATE TABLE prg_examiners_basic_adl(
            ...
            COMMENT 'ข้อมูลการทดสอบ Basic ADL';
        ");
    }

    public function down()
    {
        $this->dbforge->drop_table('prg_examiners_basic_adl');
    }
}
?>